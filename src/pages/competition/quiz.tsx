  ...
  return (
    <div className="relative h-screen overflow-clip">
      ...
      <div className="flex h-[86vh] w-full flex-col items-center space-y-4 overflow-y-scroll bg-[#F4F4F4] px-5 py-6 lg:hidden">
        <h3 className="text-lg font-semibold">Nomor 1</h3>
      ...
      <div className="flex w-full overflow-y-scroll">
        ...
        <div className="flex h-full w-full flex-col items-center space-y-8  py-8">
          <h3 className="text-xl font-bold">Nomor 1</h3>
          ...
          <div className="flex h-auto w-[80%] items-end justify-between">
            <button className="flex items-center space-x-4 rounded-lg bg-primary-dark py-2 px-3 shadow-md">
              <IoChevronBack size={20} className="text-white" />
              <p className="text-sm font-medium text-white">Soal sebelumnya</p>
            </button>
            <button className="flex items-center space-x-3 rounded-md border-[0.75px] border-primary-dark bg-white py-2 px-3 text-primary-dark shadow-md">
              <svg
                className="h-4 w-4"
                viewBox="0 0 24 24"
                fill="none"
      ...
      <nav className="absolute bottom-0 z-30 flex h-[7vh] w-full items-center justify-between bg-primary-dark px-5 lg:hidden">
        ...
        <button className="flex items-center space-x-3 rounded-md border-[0.75px] border-white py-1 px-4 text-white">
          <svg
            width="16"
            height="16"
            viewBox="0 0 20 20"
